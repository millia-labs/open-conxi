...
- Net on both sides: the bid price of a night is the contribution the hotel expects to lose, so displaced transient revenue is taken net of variable cost and acquisition cost before it is compared with the group's net contribution. Talluri and van Ryzin (2004), chapter 2, define the displacement cost in these contribution terms.

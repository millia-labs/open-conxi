@echo off
rem Double-click installer for Windows. Copies the fourteen Open Conxi skills into
...
set DONE=0
set SKIPPED=
for %%s in (hotel-setup hotel-dashboard morning-flash review-replies guest-messages turnover-board work-orders rate-check group-displacement staff-roster ota-reconciliation owner-report hotel-routine hotel-sops) do call :one %%s
echo.
